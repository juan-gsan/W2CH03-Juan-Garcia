const registerNumbers = (
  ...
  numberZeroButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "0") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberOneButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "1") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberTwoButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "2") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberThreeButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "3") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberFourButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "4") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberFiveButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "5") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberSixButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "6") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberSevenButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "7") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberEightButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "8") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
  ...
  numberNineButton.addEventListener("click", () => {
    if (
      ...
      firstOperand =
        Math.round(
          (Number(currentDisplayNumber.textContent + "9") + Number.EPSILON) *
            1000
        ) / 1000;
      currentDisplayNumber.textContent = firstOperand;
    }
...
const registerEventListeners = (
  ...
  percentageButton.addEventListener("click", () => {
    ...
    firstOperand =
      Math.round(
        (Number(currentDisplayNumber.textContent) + Number.EPSILON) * 1000
      ) / 1000;
  ...
  equalButton.addEventListener("click", () => {
    if (add === true) {
      ...
      currentDisplayNumber.textContent =
        Math.round((firstOperand + secondOperand + Number.EPSILON) * 1000) /
        1000;
...
const calculator = () => {
  const currentDisplayNumber = document.querySelector(".current-display");
  const previousDisplayNumber = document.querySelector(".previous-display");
  let firstOperand;
  let secondOperand;
  let errorMessage;
  let error;
...
exports.registerNumbers = registerNumbers;
